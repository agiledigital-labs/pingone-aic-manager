...
interface DeviceProfilesDao {
  ...
  saveDeviceProfiles(username: StringLike, realm: StringLike, deviceProfiles: any[]): void;
}
...
interface CallbacksBuilder {
  ...
  idPCallback(provider: StringLike, clientId: StringLike, redirectUri: StringLike, scope: any[], nonce: StringLike, request: StringLike, requestUri: StringLike, acrValues: any[], requestNativeAppForUserInfo: boolean): void;
  idPCallback(provider: StringLike, clientId: StringLike, redirectUri: StringLike, scope: any[], nonce: StringLike, request: StringLike, requestUri: StringLike, acrValues: any[], requestNativeAppForUserInfo: boolean, token: StringLike, tokenType: StringLike): void;
  httpCallback(authRHeader: StringLike, negoName: StringLike, negoValue: StringLike, errorCode: number): void;
  httpCallback(authorizationHeader: StringLike, negotiationHeader: StringLike, errorCode: StringLike): void;
  ...
  consentMappingCallback(name: StringLike, displayName: StringLike, icon: StringLike, accessLevel: StringLike, titles: any[], message: StringLike, isRequired: boolean): void;
  ...
  kbaCreateCallback(prompt: StringLike, predefinedQuestions: any[], allowUserDefinedQuestions: boolean): void;
  selectIdPCallback(providers: object): void;
  termsAndConditionsCallback(version: StringLike, terms: StringLike, createDate: StringLike): void;
  metadataCallback(outputValue: object): void;
  stringAttributeInputCallback(name: StringLike, prompt: StringLike, value: StringLike, required: boolean, policies: object, validateOnly: boolean, failedPolicies: any[]): void;
  stringAttributeInputCallback(name: StringLike, prompt: StringLike, value: StringLike, required: boolean): void;
  stringAttributeInputCallback(name: StringLike, prompt: StringLike, value: StringLike, required: boolean, failedPolicies: any[]): void;
  stringAttributeInputCallback(name: StringLike, prompt: StringLike, value: StringLike, required: boolean, policies: object, validateOnly: boolean): void;
  numberAttributeInputCallback(name: StringLike, prompt: StringLike, value: number, required: boolean, policies: object, validateOnly: boolean, failedPolicies: any[]): void;
  numberAttributeInputCallback(name: StringLike, prompt: StringLike, value: number, required: boolean): void;
  numberAttributeInputCallback(name: StringLike, prompt: StringLike, value: number, required: boolean, failedPolicies: any[]): void;
  numberAttributeInputCallback(name: StringLike, prompt: StringLike, value: number, required: boolean, policies: object, validateOnly: boolean): void;
  booleanAttributeInputCallback(name: StringLike, prompt: StringLike, value: boolean, required: boolean, policies: object, validateOnly: boolean, failedPolicies: any[]): void;
  booleanAttributeInputCallback(name: StringLike, prompt: StringLike, value: boolean, required: boolean): void;
  booleanAttributeInputCallback(name: StringLike, prompt: StringLike, value: boolean, required: boolean, failedPolicies: any[]): void;
  booleanAttributeInputCallback(name: StringLike, prompt: StringLike, value: boolean, required: boolean, policies: object, validateOnly: boolean): void;
  pollingWaitCallback(waitTime: StringLike, message: StringLike): void;
  confirmationCallback(messageType: number, options: any[], defaultOption: number): void;
  confirmationCallback(prompt: StringLike, messageType: number, options: any[], defaultOption: number): void;
  confirmationCallback(prompt: StringLike, messageType: number, optionType: number, defaultOption: number): void;
  ...
  choiceCallback(prompt: StringLike, choices: any[], defaultChoice: number, multipleSelectionsAllowed: boolean): void;
  redirectCallback(redirectUrl: StringLike, redirectData: object, method: StringLike): void;
  redirectCallback(redirectUrl: StringLike, redirectData: object, method: StringLike, statusParameter: StringLike, redirectBackUrlCookie: StringLike, setTrackingCookie: boolean): void;
  redirectCallback(redirectUrl: StringLike, redirectData: object, method: StringLike, setTrackingCookie: boolean): void;
  redirectCallback(redirectUrl: StringLike, redirectData: object, method: StringLike, statusParameter: StringLike, redirectBackUrlCookie: StringLike): void;
  ...
  validatedUsernameCallback(prompt: StringLike, policies: object, validateOnly: boolean, failedPolicies: any[]): void;
  validatedPasswordCallback(prompt: StringLike, echoOn: boolean, policies: object, validateOnly: boolean): void;
  validatedPasswordCallback(prompt: StringLike, echoOn: boolean, policies: object, validateOnly: boolean, failedPolicies: any[]): void;
}
