...
const MANAGED: &[(&str, &str)] = &[
    ...
    (
        "am/types/secrets.d.ts",
        include_str!("templates/am/types/secrets.d.ts"),
    ),
    (
    ...
    (
        "am/types/library-args.d.ts",
        include_str!("templates/am/types/library-args.d.ts"),
    ),
    (
    ...
    (
        "am/types/oauth2-access-token.d.ts",
        include_str!("templates/am/types/oauth2-access-token.d.ts"),
    ),
    (
