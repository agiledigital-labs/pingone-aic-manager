...
CI runs eight more that these do not cover: the sensitive-metadata scanner
...
`scripts/release-check.sh` runs **all thirteen** and refuses to report ready if
