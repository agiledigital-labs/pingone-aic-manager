...
Updated 2026-06-13; the feature-vertical restructure is **complete** (rationale:
...
| CLI root (clap, login/logout/stop/status, ctx, whoami)                                 | `src/cli/mod.rs` (feature subcommands live in each vertical's `cli.rs`)                                                                                                                                                                                                                                | `docs/CLI.md`                                                |
